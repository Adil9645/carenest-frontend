...
import blood from "../../../web/assets/images/blood.jpg";
import "./labresult.css";
import weight from "../../../web/assets/images/weight.png";
...
export const Labresults = () => {
        ...
        Latest Report
                ...
                <Labreport docname={"General Health"} files={"8 files"} fileimage={"../../../web/assets/images/filesicon.jpg"} />
                <Labreport docname={"General Health"} files={"8 files"} fileimage={"../../../web/assets/images/filesicon.jpg"} />
